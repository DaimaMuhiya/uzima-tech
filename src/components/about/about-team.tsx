...
const teamMembers = [
  {
    name: "John Doe",
    role: "CEO & Founder",
    image: "/placeholder.svg?height=467&width=285",
  },
  {
    name: "Jane Smith",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            <h3 className="text-4xl lg:text-5xl font-bold text-white max-w-md tracking-wider">
              Meet Our Team of
              <br />
              Professionals.
            </h3>
            ...
            <Button
              variant="outline"
              className="border-[#F54A48] text-white hover:bg-[#F54A48] px-8 py-3 rounded-full lg:mb-2 bg-transparent uppercase"
            >
              all members
            </Button>
          </div>
