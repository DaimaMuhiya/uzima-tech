          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4">
                <Check className="h-6 w-6 text-[#FA982F] flex-shrink-0" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-gradient-to-r from-[#7436BB] to-[#B520A3] hover:from-[#7436BB]/90 hover:to-[#B520A3]/90 text-white px-8 py-6 rounded-full">
                GET STARTED
              </Button>
              <Button
                variant="outline"
                className="border-[#F54A48] text-white hover:bg-[#F54A48] px-8 py-6 rounded-full bg-transparent"
              >
                DISCOVER MORE
              </Button>
            </div>
